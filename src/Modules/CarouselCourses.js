    ...
    <div class='item'>
        ...
        <div className="text-start mt-5">
            <a href="https://www.ibresp.com.br/Curso-TTI-IBRESP/" target="_self">
                <button className=" bg-cyan-950 text-white rounded-md hover:bg-cyan-300 hover:text-white hover:scale-110 duration-300 ease-in-out px-4 py-2 mb-14 md:mb-2 text-md font-normal"> Saiba mais</button>
            </a>
        </div>
    </div>
