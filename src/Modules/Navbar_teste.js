...
const navigation = [
{ name: 'Loja', href: 'https://ibresp.com.br/loja/Inicio', current: true },
{ name: 'Cursos', href: '#', current: false },
{ name: 'O IBRESP', href: '#', current: false },
{ name: 'Conteúdo', href: '#', current: false },
{ name: 'Soluções', href: '#', current: false },
{ name: 'AVA', href: '#', current: false },
]
...
<div className={colorChange ? "navbarcolor active": "navbarcolor"}>    
    ...
    <div className='container mx-auto'>    
        ...
        <Disclosure as="nav" className="py-8">
            {({ open }) => (
            <>
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            <div className="flex flex-grow items-center">
                                ...
                                <a href="https://www.ibresp.com.br/" target="_self">
                                    <img className="h-12 w-auto" src={logo} alt="Logo IBRESP" title="Logo IBRESP"/>
                                </a>
                            ...
                            <Menu as="div" className="relative ml-3">
                                ...
                                >
                                    ...
                                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                        ...
                                        <Menu.Item>
                                        {({ active }) => (
                                            <a  href="https://www.ibresp.com.br" className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                                                Settings
                                            </a>
                                        )}
                                        </Menu.Item>
