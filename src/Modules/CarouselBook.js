...
<OwlCarousel className='ebooks owl-theme' autoplay loop margin={30}  stagePadding={60} responsive= {
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Direito} alt='Conhecimentos Gerais do Direito Imobiliário'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Guia} alt='Como se tornar um corretor de imóveis'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Vistoria} alt='Como realizar uma boa vistoria imobiliária'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Hospitalidade} alt='Sobre hospitalidade imobiliária'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Regularizacao} alt='Regularização de imóveis na prática'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Compliance} alt='Compliance para a área imobiliária'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Luxo} alt='Mercado de luxo na área imobiliária'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Midias} alt='Mídias sociais para a área imobiliária'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Hp12c} alt='Práticas com a HP 12c'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Financiamento} alt='Guia prático de financiamento imobiliário'/>
    ...
    <div class='item'>
        <img width='auto' height='auto' className='rounded-xl shadow-lg mb-5' src={Avalion} alt='Saiba como captar imóveis de forma efetiva'/>
