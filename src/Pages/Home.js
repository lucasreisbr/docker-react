...
<div>
    ...
    <section className="flex flex-row justify-center">
        <div className="container">
            <h1 className=' text-orange-400 mb-8 text-4xl font-bold px-3 xl:px-0'>
            ...
            <div>
                ...
                <div className="text-start mt-5">
                    <a href="https://www.ibresp.com.br/especialista/Vendas/" target="_self">
                        <button className=" bg-orange-400 text-white rounded-md hover:bg-orange-600 hover:text-white hover:scale-110 duration-300 ease-in-out px-4 py-2 md:mb-2 text-md font-normal mb-4"> Saiba mais</button>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="text-start mt-5">
                    <a href="https://www.ibresp.com.br/especialista/Avaliacao/" target="_self">
                        <button className=" bg-orange-400 text-white rounded-md hover:bg-orange-600 hover:text-white hover:scale-110 duration-300 ease-in-out px-4 py-2 md:mb-2 text-md font-normal"> Saiba mais</button>
                    </a>
                </div>
        ...
        <div className="w-full">
            <div className='container mx-auto px-3 xl:px-0'>
                ...
                <div className="text-center my-20">
                    <a href="https://www.ibresp.com.br/Curso-TTI-IBRESP/" target="_self">
                        <button className=" bg-orange-400 text-white rounded-md hover:bg-orange-600 hover:text-white hover:scale-110 duration-300 ease-in-out px-5 py-3 md:mb-2 text-lg font-bold"> Saiba mais</button>
                    </a>
                </div>
