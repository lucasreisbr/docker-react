        ...
        <div className="w-full">
            <div className='container mx-auto px-3 xl:px-0'>
                ...
                <div className="text-center my-20">
                    <a href="https://www.ibresp.com.br/Curso-TTI-IBRESP/" target="_self">
                        <button className=" bg-orange-400 text-white rounded-md hover:bg-orange-400 hover:text-white hover:scale-110 duration-300 ease-in-out px-5 py-3 md:mb-2 text-lg font-bold"> Saiba mais</button>
                    </a>
                </div>
